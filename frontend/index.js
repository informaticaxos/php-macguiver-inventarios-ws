$(document).ready(function () {
    ...
    $('#content-area').html('<div id="productos-content" class="text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Cargando...</span></div></div>' + searchHtml + resultsHtml);
        loadProductosStats();
    }
